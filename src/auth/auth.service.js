    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.register = function (registerDto) {
            return __awaiter(this, void 0, void 0, function () {
                var name, surname, email, password, hashedPassword, user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            name = registerDto.name, surname = registerDto.surname, email = registerDto.email, password = registerDto.password;
        ...
        AuthService_1.prototype.login = function (loginDto) {
            return __awaiter(this, void 0, void 0, function () {
                var email, password, user, _a, payload, accessToken;
